      ...
      <div className="bg-white border-t border-gray-100 px-8 py-4">
        <div className="flex gap-3">
          <input
            ...
            disabled={loading}
            className="flex-1 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 disabled:opacity-50"
          />
          <button onClick={() => handleAsk()} disabled={loading || !question.trim()}
            className="bg-indigo-600 text-white px-5 py-3 rounded-xl font-medium hover:bg-indigo-700 transition disabled:opacity-40 text-sm">
            Ask
          </button>
        </div>
      </div>
